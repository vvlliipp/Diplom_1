...
def test_add_ingredient(ingredient_name, ingredient_price):
...
def test_get_price(bun_price, ingredient_price, expected_price):
    mock_bun = Mock()
    mock_bun.get_price.return_value = bun_price
...
def test_bun_name_ingredient_name_and_price_in_receipt():
    mock_bun = Mock()
